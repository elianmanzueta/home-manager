return {
  ...
  config = function()
    require("org-super-agenda").setup({
      ...
      org_files = { "~/org/roam/daily/work-inbox.org" },
      org_directories = { "~/org/roam/professional" }, -- recurse for *.org
      exclude_files = {},
      exclude_directories = { "~/org/roam/archive" },
      ...
      allow_duplicates = true, -- if true, an item can live in multiple groups
